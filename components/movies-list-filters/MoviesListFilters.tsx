...
import { Box, Button, Grid, Paper, SelectChangeEvent, Theme, useMediaQuery } from '@mui/material'
import { DatePicker, LocalizationProvider } from '@mui/x-date-pickers'
import { AdapterMoment } from '@mui/x-date-pickers/AdapterMoment'

import { AppDispatch, RootState } from '@/lib/store'
import { getListMovies, resetParams, setParams } from '@/lib/movies/actions';
                            ...
                            <Grid item xs={12} sm={6} md={2} lg={2}>
                                <LocalizationProvider dateAdapter={AdapterMoment}>
                                    <DatePicker
                                        ...
                                        value={year ? moment().set("year", year) : (year as null)}
                                        maxDate={moment()}
                                        views={['year']}
                                        onChange={(value) => 
